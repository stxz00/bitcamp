...
if("POST".equals(method)){
	...
	try{
		...
		pstmt.setString(1, sub); //? 순으로 하는것 프리페어스테이트먼트는 보안때문에 만들어짐
		pstmt.setString(2, name); //또한 자료형이 미스매치나면 틀리게 하여 자연스럽게 보안이 됨
		pstmt.setString(3, content);
		//pstmt.setDate(4, new java.sql.Date(System.currentTimeMillis())); //sql date를 상속받음
